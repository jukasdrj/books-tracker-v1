...
actor EnrichmentAPIClient {
    ...
    func startEnrichment(jobId: String, books: [Book]) async throws -> EnrichmentResult {
        ...
        // Feature flag available to disable canonical endpoint if needed: feature.disableCanonicalEnrichment
        let disableCanonical = UserDefaults.standard.bool(forKey: "feature.disableCanonicalEnrichment")
